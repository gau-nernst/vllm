...
def chunk_gated_delta_rule_cutedsl(
    ...
    _, Hv, V_dim, K_dim = initial_state.shape
    BT = 64
    ...
    u = q.new_empty(pad_t, Hv, V_dim)
    w = q.new_empty(pad_t, Hv, K_dim)
    ...
    h = k.new_empty(num_chunks, Hv, V_dim, K_dim)
    v_new = q.new_empty(pad_t, Hv, V_dim)
